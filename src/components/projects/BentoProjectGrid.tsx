...
const BentoProjectGrid = () => {
  ...
  return (
    <main className="w-full h-full bg-black">
      <p className="text-6xl font-bold text-white mb-7 pt-[10rem] flex justify-center" style={{ fontFamily: "afacad-bold" }}>
        PROJECTS
      </p>

      <div className="sticky_parent h-[500vh]">
        <div className="sticky top-0 h-screen overflow-hidden">
          <div className="scroll_section absolute top-0 h-full w-[500vw] will-change-transform flex justify-between items-center px-[5vw]">
            {projects.map((project, index) => (
              <div key={index} className="w-[100vw] flex flex-col justify-center items-center text-center text-white">
                <img src={project.image} alt={project.name} className=" h-[400px] rounded-xl shadow-lg mb-4" />
      ...
      <section className="h-full">
        <div className="container p-20 text-center">
          ...
          <p className="w-1/2 mx-auto my-8">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque sunt nihil beatae qui dicta necessitatibus officia repudiandae mollitia aliquam! Molestias aliquam quos est nam, perferendis ullam iusto earum aut voluptates.
          </p>
        </div>
      </section>
    </main>
